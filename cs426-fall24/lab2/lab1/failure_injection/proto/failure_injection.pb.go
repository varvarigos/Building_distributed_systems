...
var file_failure_injection_proto_failure_injection_proto_goTypes = []any{
...
func file_failure_injection_proto_failure_injection_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_failure_injection_proto_failure_injection_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_failure_injection_proto_failure_injection_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_failure_injection_proto_failure_injection_proto_msgTypes[2].Exporter = func(v any, i int) any {
